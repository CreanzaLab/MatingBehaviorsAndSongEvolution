...
browniefunction <- function(MateParam = MateParam,SongParam = SongParam, matensim = 500, phylanova = "not evaluated", minmax = NULL, newtree = FALSE) {
  ...
  #write.csv(file = paste("brownie",matensim,"sim",MateParam,SongParam,minmax,".csv",sep=""), browniedata)
  
  brownied <- browniedata
  write.csv(brownied,file = paste("brownie",matensim,MateParam,SongParam,"GENE.csv",sep=""))
