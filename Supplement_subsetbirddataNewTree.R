...
subsetbirddata <- function(MateParam=c("Polygyny","EPP","OC","none"),SongParam=c("Song","Syllsong","Syllrep","Interval","Duration","Rate","Continuity","OC","none"), withsuboscines = FALSE, newdata = FALSE, newtree = newtree, islog = TRUE, minmax = NA) {
require(phytools)
require(ape)
require(maps)
...
if (newtree == FALSE) {
  ...
  matezillatree <- read.nexus(newtree) 
  }
