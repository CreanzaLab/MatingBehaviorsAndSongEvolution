...
#Must set .BayesTraitsPath to location of program BayesTraitsV2, which must be located in your wroking directory. E.g.:
#.BayesTraitsPath <- "~/Documents/VANDERBILT/CreanzaLab/BayesTraits/AlexBayesTraits/BayesTraitsV2"
